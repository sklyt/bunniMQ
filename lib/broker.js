...
// FIXME: (really bad) Invert control,  fragmanted code is bad,  all managers should be initialized on startup: entry point (e.g. bunni.js), centralize startup logic
